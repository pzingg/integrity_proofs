defmodule DidServer.Accounts.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :username, :domain, :password])
    |> validate_email(opts)
    |> validate_domain()
  ...
  defp validate_username(changeset, opts) do
    ...
    |> validate_format(:username, ~r/^[a-z][-_.a-z0-9]+$/, message: "must start with a-z, be only a-z, 0-9, . -, or _")
  ...
  """
  def valid_password?(%DidServer.Accounts.User{hashed_password: hashed_password}, password)
